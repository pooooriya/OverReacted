...
namespace OverReacted.Infrastructure.Migrations
{
    ...
    [Migration("20220716075512_SeedDataForUser")]
            ...
            modelBuilder.Entity("OverReacted.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOnUTC = new DateTimeOffset(new DateTime(2022, 7, 16, 7, 55, 11, 870, DateTimeKind.Unspecified).AddTicks(1932), new TimeSpan(0, 0, 0, 0, 0)),
                            Email = "Dan.Abramov@Facebook.com",
                            IsActive = true,
                            IsEmailActive = true,
                            LastVerificationSent = new DateTimeOffset(new DateTime(2022, 7, 16, 7, 55, 11, 870, DateTimeKind.Unspecified).AddTicks(2659), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Dan Abramov",
                            Password = "73l8gRjwLftklgfdXT+MdiMEjJwGPVMsyVxe16iYpk8=",
                            RoleId = 2,
                            VerifyCode = "01c0e6575d5540df90b41da9aca4bd4e"
                        });
                });
